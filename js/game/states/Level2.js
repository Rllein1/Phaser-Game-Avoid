Avoid.Level2 = function(){
	...
	this.virusRate = 800; //generate coins every 800ms
...
Avoid.Level2.prototype = {
	create: function(){
		this.background2 = this.game.add.tileSprite(0, -73, 3000, 473, 'background2');//add background
		this.building2 = this.game.add.tileSprite(0, 10, 3000, 473, 'building2');//add building

		this.sky2 = this.game.add.tileSprite(0, -73, 3000, 473, 'sky2');//add sky
        this.sky2.autoScroll(-80, 0); //this will move the sky to the left
        ...
        this.game.physics.arcade.enableBody(this.building2); //apply physics to this object
        this.building2.body.immovable = true; //this will keep the building stay in place
        ...
        this.level = this.game.add.bitmapText(10,10, 'minecraftia', 'LEVEL 2', 32); //show game level
	...
	update: function(){
        ...
        this.game.physics.arcade.collide(this.hero,this.building2,this.buildingHit, null, this);
    ...
    buildingHit: function(hero, building2){
    ...
    virusHit: function(hero, virus){
        ...
        if (this.heroLife <= 0 ) {
            ...
            this.sky2.stopScroll(); //will stop sky from scrolling
            ...
            scoreboard2.show(this.score); // show the scoreboard
        }
    },
    safeHit: function(hero, safe){
        ...
        this.capsuleTimer = Number.MIN_VALUE; //stop generating capsule
        var scoreboardwin2 = new ScoreboardWin2(this.game);
        scoreboardwin2.show(this.score); //show scoreboardwin
        this.win.play();
    },
