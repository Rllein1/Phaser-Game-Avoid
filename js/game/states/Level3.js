Avoid.Level3 = function(){
	...
	this.virusRate = 600; //generate coins every 600ms
...
Avoid.Level3.prototype = {
	create: function(){
		this.background3 = this.game.add.tileSprite(0, -73, 3000, 473, 'background3');//add background
		this.building3 = this.game.add.tileSprite(0, 10, 3000, 473, 'building3');//add building

		this.sky3 = this.game.add.tileSprite(0, -73, 3000, 473, 'sky3');//add sky
        this.sky3.autoScroll(-80, 0); //this will move the sky to the left
        ...
        this.game.physics.arcade.enableBody(this.building3); //apply physics to this object
        this.building3.body.immovable = true; //this will keep the building stay in place
        ...
        this.bullets.enableBody = true; //enable the physics to bullet along with the hero

        //enable physics to bulletss
        this.bullets.physicsBodyType = Phaser.Physics.ARCADE; 

        this.bullets.createMultiple(1, 'bullet');// how many bullet relese every pressing the key
        ...
        this.level = this.game.add.bitmapText(10,10, 'minecraftia', 'LEVEL 3', 32); //show game level
	...
	update: function(){
        ...
        this.game.physics.arcade.collide(this.hero,this.building3,this.buildingHit, null, this);
    ...
    buildingHit: function(hero, building3){
    ...
    virusHit: function(hero, virus){
        ...
        this.chardied.play(); //play sound when the hero hit the viirus
        ...
        if (this.heroLife <= 0 ) {
            ...
            this.sky3.stopScroll(); //will stop sky from scrolling
            ...
            scoreboard3.show(this.score); // show the scoreboard
        }
    },
    safeHit: function(safe){
        ...
        this.capsuleTimer = Number.MIN_VALUE; //stop generating capsule
        var scoreboardwin3 = new ScoreboardWin3(this.game);
        scoreboardwin3.show(this.score); //show scoreboardwin
        this.win.play();
    },
