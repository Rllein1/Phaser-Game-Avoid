Avoid.Level5 = function(){
	...
	this.virusRate = 300; //generate coins every 300ms
...
Avoid.Level5.prototype = {
	create: function(){
		this.background5 = this.game.add.tileSprite(0, -73, 3000, 473, 'background5');//add background
		this.building5 = this.game.add.tileSprite(0, 10, 3000, 473, 'building5');//add builduing

		this.sky5 = this.game.add.tileSprite(0, -73, 3000, 473, 'sky5');//add sky
        this.sky5.autoScroll(-80, 0); //this will move the sky to the left
        ...
        this.snow = this.game.add.tileSprite(0, -73, 3000, 1000, 'snow');//add snow
        this.snow.autoScroll(0, 80); //this will move the snow downward
        ...
        this.game.physics.arcade.enableBody(this.building5); //apply physics to this object
        this.building5.body.immovable = true; //this will keep the building stay in place
        ...
        this.bullets.createMultiple(1, 'bullet');// how many bullet realsease every pressing the key
        ...
        this.level = this.game.add.bitmapText(10,10, 'minecraftia', 'LEVEL 5', 32); //show game level
    ...
    fireBullet:function(){ //recycle bullet and add to bullet group
	    ...
	    bullet = this.bullets.getFirstExists(false);
	        ...
	        if (bullet){
	            bullet.reset(this.hero.x + 150, this.hero.y +40); // position of bullet from player
    ...
    buildingHit: function(hero, building5){
    ...
    virusHit: function(hero, virus){
        ...
        if (this.heroLife <= 0 ) {
            ...
            this.sky5.stopScroll(); //will stop sky from scrolling
            ...
            var scoreboard5 = new Scoreboard5(this.game);
            scoreboard5.show(this.score); // show the scoreboard
        }
    },
    safeHit: function(safe){
        ...
        this.virusTimer = Number.MAX_VALUE; //stop generating enemies
        this.capsuleTimer = Number.MIN_VALUE; //stop generating capsule
        var scoreboardwin5 = new ScoreboardWin5(this.game);
        scoreboardwin5.show(this.score); //show scoreboardwin
        this.victory.play();
    },
