var Scoreboard5 = function(game){
    Phaser.Group.call(this, game); //Group is inheritance of Phaser with reference to the 'game'
};
Scoreboard5.prototype = Object.create(Phaser.Group.prototype);
Scoreboard5.prototype.constructor = Scoreboard5;
...
Scoreboard5.prototype.show = function(score){
...
Scoreboard5.prototype.restart = function(){//enable to restart the game
