var ScoreboardWin4 = function(game){
    Phaser.Group.call(this, game); //Group is inheritance of Phaser with reference to the 'game'
};
ScoreboardWin4.prototype = Object.create(Phaser.Group.prototype);
ScoreboardWin4.prototype.constructor = ScoreboardWin4;
...
ScoreboardWin4.prototype.show = function(score){
...
ScoreboardWin4.prototype.onClick = function(){//enable to go to MainMenu2 state to choose game level
