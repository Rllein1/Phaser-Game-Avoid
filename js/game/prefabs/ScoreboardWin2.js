var ScoreboardWin2 = function(game){
    Phaser.Group.call(this, game); //Group is inheritance of Phaser with reference to the 'game'
};
ScoreboardWin2.prototype = Object.create(Phaser.Group.prototype);
ScoreboardWin2.prototype.constructor = ScoreboardWin2;
...
ScoreboardWin2.prototype.show = function(score){
...
ScoreboardWin2.prototype.onClick = function(){//enable to go to MainMenu2 state to choose game level
