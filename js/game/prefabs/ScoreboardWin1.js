var ScoreboardWin1 = function(game){
    Phaser.Group.call(this, game); //Group is inheritance of Phaser with reference to the 'game'
};
ScoreboardWin1.prototype = Object.create(Phaser.Group.prototype);
ScoreboardWin1.prototype.constructor = ScoreboardWin1;
...
ScoreboardWin1.prototype.show = function(score){
    ...
    //Adding next button enable to proceed next state
...
ScoreboardWin1.prototype.onClick = function(){//enable to go to MainMenu2 state to choose game level
