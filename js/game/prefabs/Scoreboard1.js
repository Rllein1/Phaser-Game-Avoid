var Scoreboard1 = function(game){
    Phaser.Group.call(this, game); //Group is inheritance of Phaser with reference to the 'game'
};
Scoreboard1.prototype = Object.create(Phaser.Group.prototype);
Scoreboard1.prototype.constructor = Scoreboard1;
...
Scoreboard1.prototype.show = function(score){
...
Scoreboard1.prototype.restart = function(){ //enable to restart the game
