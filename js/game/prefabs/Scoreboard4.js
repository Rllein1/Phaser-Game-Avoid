var Scoreboard4 = function(game){
    Phaser.Group.call(this, game); //Group is inheritance of Phaser with reference to the 'game'
};
Scoreboard4.prototype = Object.create(Phaser.Group.prototype);
Scoreboard4.prototype.constructor = Scoreboard4;
...
Scoreboard4.prototype.show = function(score){
...
Scoreboard4.prototype.restart = function(){//enable to restart the game
